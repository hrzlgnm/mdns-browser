...
makedepends="libwebkit2gtk41-devel wget file gtk+3-devel librsvg-devel"
depends="libwebkit2gtk41"
short_desc="Cross platform mDNS browsing app written in rust using tauri and leptos"
...
do_install() {
	...
	# install the plain binary without bundler type
	vinstall target/release/mdns-browser 0755 /usr/bin/mdns-browser
	vlicense LICENSE
}
EOF
