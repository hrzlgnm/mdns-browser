...
pub fn App() -> impl IntoView {
    ...
    log::debug!("App after provide_meta_context");
    ...
    log::debug!("App after provide_context");
    view! {
        <ThemeProvider theme>
            <GlobalStyle />
