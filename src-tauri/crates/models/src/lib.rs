...
mod ts_export {
    ...
    /// Run the export test below; CI fails on drift with
    ...
    fn export_types() {
        ...
        let mut out = String::from(
            "// GENERATED by ts-rs — do not edit. Regenerate with `cargo test --manifest-path src-tauri/Cargo.toml -p models --lib ts_export::export_types`.\n",
        );
